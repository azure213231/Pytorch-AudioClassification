...
def get_test_data_list(audio_path, list_path):
    sound_sum = 0
    audios = os.listdir(audio_path)
...
if __name__ == '__main__':
    # 生成训练集
    get_data_list('dataset/audio/train-dataSet-2024-03-06-10类目-denoise2', 'dataset')
    # 生成测试集
    # get_test_data_list('docs/test_audio/test-dataSet-2024-03-04-10类目-denoise2', 'dataset')
    # 生成生成方言数据列表
